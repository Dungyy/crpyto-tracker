    ...
    return (
        <>
                ...
                <Container>
                    ...
                    <Navbar.Collapse id="basic-navbar-nav">
                        <Nav className="me-auto">
                            {coins.length > 0 && (
                                <Nav.Item className="d-flex align-items-center market-cap-display">
                                    <small className="text-muted me-2">Total Market Cap:</small>
                                    <span className="fw-bold market-cap-value">
                        ...
                        <Nav>
                            <Button
                                ...
                                className="d-flex align-items-center theme-toggle"
                            >
                                {darkMode ? (
                                    <>
            ...
            <main className="main-content">
                <div className="content-wrapper mt-5 pt-3">
                    {children}
                </div>
            </main>
        </>
